...
function EnfantHospitali2() {
  ...
  const fetchhospitalisations = async () => {
    axios
      .get(
        "https://gestionnouveaune.abahs-jobconnect.online/hospitalisation/All",
        {
          ...
          <div className="mb-2   p-2 sm:mt-2 mt-1 w-full flex">
                ...
                <div className="flex items-center">
                  <div className="flex relative">
                    <input
                      ...
                      placeholder="Recherche la Vaccination"
                    />
                  ...
                  {IsPrinting ? (
                    ...
                    <>
                      <Whisper
                        ...
                        speaker={
                          <Popover>
                            Imprimer la liste des hospitalisations
                          </Popover>
                        }
                      >
                        <div
            ...
            <div className="flex  justify-end w-max ">
              <Whisper
                ...
                placement="left"
                speaker={
                  <Popover>Click pour ajouter un enfant a l'hopital</Popover>
                }
              >
                <Link to="/hopit/enfant" className="w-max p-2 cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    ...
                    hospitalisations.map((data) => {
                      return (
                        <tr className="border-b">
                          ...
                          <td className="p-1 border-r">
                            {formatDate(data.date_admission)}
                          </td>
                          <td className="p-1 border-r">
                            {formatDate(data.date_sortie)}
                          </td>
                          <td className="p-1 border-r">
                            {data.raison_admission}{" "}
                          </td>
                          <td className="p-1 border-r">{data.traitement}</td>
                          <td className="border-r flex justify-center items-center h-12">
                            <Whisper
                              trigger="hover"
                              placement="left"
                              speaker={<Popover>Détail</Popover>}
                            >
                              <Link
                                to={`/hopit/detail/${encryptData(
                                  data.id.toString()
                                )}`}
...
export default EnfantHospitali2;

class PrintAll extends Component {
  render() {
    const { formatDate, hospitalisations } = this.props;
    return (
                ...
                hospitalisations.map((data) => {
                  return (
                    <tr className="border-b">
                      ...
                      <td className="p-1 border-r">{data.raison_admission} </td>
                      <td className="p-1 border-r">{data.traitement}</td>
                    </tr>
                  );
                })}
