...
function Vaccination2() {
  ...
  const fetchVaccinations = async () => {
    axios
      .get("https://gestionnouveaune.abahs-jobconnect.online/Vaccination/All", {
          ...
          <div className="mb-2   p-2 sm:mt-2 mt-1 w-full flex">
                  ...
                  {IsPrinting ? (
                    ...
                    <>
                      <Whisper
                        ...
                        placement="auto"
                        speaker={
                          <Popover>Imprimer la liste des Vaccinations</Popover>
                        }
                      >
                        <div
                          onClick={() => {
            ...
            <div className="flex  justify-end w-max ">
              <Whisper
                trigger="hover"
                placement="left"
                speaker={<Popover>Click pour ajouter une Vaccination</Popover>}
              >
                <Link to="/consult/enfant" className="w-max p-2 cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    ...
                    Vaccinations.map((data) => {
                      return (
                        <tr className="border-b">
                          ...
                          <td className="p-1 border-r">{data.vaccin}</td>
                          <td className="p-1 border-r w-[5em]">
                            <div className="flex items-center justify-center w-full">
                              <Whisper
                                ...
                                placement="auto"
                                speaker={
                                  <Popover>Detail du Vaccination</Popover>
                                }
                              >
                                <Link
                                  to={`/Vaccination/detail/${encryptData(
                                    data.id.toString()
                                  )}`}
...
class PrintAll extends Component {
  render() {
    const { formatDate, Vaccinations } = this.props;
    return (
      <div class="w-full m-1 ">
        <div className="w-full">
          <div className=" mx-5 text-2xl  mb-4 font-bold  text-center">
            Liste des enfants Vaccinés
          </div>
