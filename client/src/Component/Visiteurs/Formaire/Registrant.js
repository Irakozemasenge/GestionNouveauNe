...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://speedreal.abahs-jobconnect.com/admin/createAccount', formData, {
            headers: {
            ...
            setpasswordConfirm('');
            setphoto('');
            navigate("/ndandStudiesLoginAdminAfricanBrainAfricanHa")
    ...
    return (
        <div className={`fixed w-full h-full z-[100] py-5 top-0 left-0 flex justify-center overflow-y-auto overflow-x-hidden bg-[white]`}>
            <div className={` bg-white  p-2 w-[35em] border shadow-2xl border-orange-600 sm: max-sm:w-[95%] rounded-3xl h-max`}>
                ...
                <form onSubmit={handleSubmit} >
                    <div className={`flex mt-4 w-full  ${mobile ? 'flex-col' : ''} `}>
                        <div className={`mb-4 ${mobile ? 'w-full' : 'w-1/2  mx-1'}`}>
                            ...
                            <input
                                ...
                                className={`border rounded p-2 w-full  bg-transparent outline-none focus:border focus:border-orange-700 ${animationClassNom}`}
                                ref={nomRef}
                                value={nom_complet}
                        ...
                        <div className={`mb-4 ${mobile ? 'w-full' : 'w-1/2  mx-1'}`}>
                            ...
                            <div className='flex relative'>
                                <input
                                    ...
                                    ref={passConfirmRef}
                                    className={`w-full  border  pr-8 outline-none ${animationClassConfirm} focus:border-orange-500  rounded-md p-2.5  bg-transparent  border-gray-200`}
                                    placeholder="Xxxxx@12"
                                />
                    ...
                    <div className="mb-4">
                        <label className={`border rounded p-2 w-full  bg-transparent outline-none focus:border focus:border-orange-700 ${animationClassProfil}`} htmlFor="profil">
                            Photo de profil
                        </label>
                        <input
                            id="profil"
                    ...
                    {photo && <div className='w-[15em] h-[15em] border m-2 rounded-xl overflow-hidden border-orange-600'>
                ...
                Vous avez  un compte ? <Link to='/ndandStudiesLoginAdminAfricanBrainAfricanHa' className='cursor-pointer hover:bg-gray-100 py-1 px-2 text-orange-700'>Se connecter</Link>
            </div>
        </div>
    );
}
