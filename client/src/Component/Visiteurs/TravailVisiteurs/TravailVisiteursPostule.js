            ...
            <div className='flex  bg-gray-50 rounded'>
                <div className='w-full  sm:p-3 p-1 rounded-xl h-max  m-2'>
                    ...
                    <div className='mt-2 text-lg'>
                        ...
                        <div className='max-sm:text-[15px]'>Pays: {travailDetails.pays}</div>
                        <div className='max-sm:text-[15px]'>Domaine: {travailDetails.domaine}</div>
                        <div className='max-sm:text-[15px]'>Niveau: {travailDetails.niveau}</div>
                        <div className='max-sm:text-[15px]'>Inscription: <span className='font-bold'>du {new Date(travailDetails.createdAt).toLocaleDateString()} au {new Date(travailDetails.fin).toLocaleDateString()}</span></div>
                    </div>
