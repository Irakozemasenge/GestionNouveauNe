        ...
        <>
            ...
            <div className={`relative  bg-gray-50 flex p-2 ${mobile1 ? 'flex-col-reverse' : 'flex-row-reverse'}`}>
                <div className={`h-full w-ull flex flex-col items-center ${mobile1 ? 'w-full mt-5' : 'w-1/2'}`}>
                    <div className={`mt-2 font-serif  ${mobile2 ? 'text-[25px] ' : mobile ? 'text-[40px] ' : 'text-[50px] '} w-full`}>Recherche du siva du pays</div>
            ...
            <div>
                ...
                {visas.length == 0 &&
                    <div className='w-full  mt-5 text-gray-500  sm:text-lg'>
