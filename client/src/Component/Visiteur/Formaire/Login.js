...
function Login({ SetisAdmin }) {
    ...
    const { isLogin, setForgetPass, SetIsLogin } = useTheme();
    ...
    const handleSubmit = (e) => {
        ...
        if (emailValue.trim() == "") {
            ...
            setboutLoading(true)
            axios.post('http://localhost:8005/admin/login', {
                email: emailValue,
                password: isPass
            })
                .then(response => {
    ...
    return (
        <>
            ...
            <Modal backdrop="static" overflow={false} open={isLogin}>
                <Modal.Body>
                    <div className='w-full  h-full overflow-auto flex justify-center sm:py-5 '>
                        <div className={` p-2 relative overflow-hidden border shadow-2xl border-[#5dca32] w-[99%] rounded-3xl h-max`}>
                            <div className="absolute w-full z-50 flex justify-end">
                                <div onClick={() => SetIsLogin(false)} className="mr-5 mt-2 bg-green-100 p-1  rounded cursor-pointer">
                            ...
                            <div className='flex justify-center w-full'>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="cursor-pointer" onClick={() => { setForgetPass(true); SetIsLogin(false) }}>
                                        Oublie le mot de passe, réinitialise-le
                                    </div>
                                </form>
                            </div>
                        </div>
