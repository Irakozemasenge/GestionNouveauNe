                ...
                <div className='flex '>
                    <div className='w-full g p-3  rounded-xl h-max  m-2'>
                        ...
                        <div className='text-[15px] mt-4 sm:text-[17px]'>
                            <div className='ms:text-[20px] max-sm:text-[18px]'>Avantages</div>
                        ...
                        <div className='text-[15px] sm:text-[17px]'>
                            <div className='ms:text-[20px] max-sm:text-[18px] mt-5'>Critere d'eligibilite</div>
                            <ul className='list-none'>
                        ...
                        <div className='flex mt-4'>
                            <Link to='/bourse/valid' className='w-max mx-1 focus:no-underline hover:no-underline px-2 block hover:text-white focus:text-white text-center cursor-pointer py-1.5 mt-1 bg-fuchsia-600 text-white rounded'>
                                Retourner
                            </Link>
...
export default BourseValidDetail
