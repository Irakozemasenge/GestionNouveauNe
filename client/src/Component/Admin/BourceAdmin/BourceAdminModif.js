...
function BourceAdminModif() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://speedreal.abahs-jobconnect.com/bourse/updateBourse/${bId}`, data) // Utilisation de 'data' au lieu de 'bourse'
            .then((resp) => {
                                            ...
                                            <div className="rounded-lg w-full">
                                                <div class="w-full mb-5">
                                                    ...
                                                    <input
                                                        ...
                                                        class="boursek w-full bg-transparent  outline-none  focus:border focus:border-orange-500   border border-red rounded py-3 px-4 mb-3"
                                                        value={bourse.titre}
...
export default BourceAdminModif;
