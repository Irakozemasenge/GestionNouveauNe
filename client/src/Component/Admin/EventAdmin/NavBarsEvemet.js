...
function NavBarsEvemet() {
    ...
    return (
        <div className='text-[20px]  h-[7vh] flex justify-between items-end'>
            ...
            >
                <Link className={`w-full border-b-2 pl-2 h-full flex items-end ${(eventList.test(pathname)) && pathname !== '/event/ajouter' && "border-orange-600 hover:text-orange-600 focus:text-orange-600 text-orange-600"}`} to='/event'>
                    {!mobile3 && <> Gérer des événements</>}
            ...
            >
                <Link className={`w-full border-b-2 h-full flex items-end ${(url == "/event/ajouter") && "border-orange-600 hover:text-orange-600 focus:text-orange-600 text-orange-600"}`} to='/event/ajouter' >
                    {!mobile3 && <> Ajoute événements</>}
