        ...
        <div className='w-full'>
            ...
            <div className={`w-full overflow-y-auto  overflow-x-hidden  ${mobile3 ? 'h-[87vh]' : 'h-[79vh]'}`}>
                <div className="flex items-center w-full justify-between">
                    <Link to='/contrant/expire' className="w-8 h-8 flex justify-center items-center text-green-500">
...
export default ExpireContrantDetail;
