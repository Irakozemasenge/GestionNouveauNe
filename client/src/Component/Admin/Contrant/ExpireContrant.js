...
function ExpireContrant() {
    ...
    const fetchcontrant = async () => {
        axios.get("http://localhost:8005/contrat/expirer", {
            params: { searchTerm: searchTerm, page: currentPage, itemsPerPage: pageSize }
        })
            .then(response => {
                setcontrant(response.data.contratExpire);
    ...
    return (
        <div className='w-full'>
            ...
            <div className={`w-full overflow-y-auto  overflow-x-hidden  ${mobile3 ? 'h-[87vh]' : 'h-[79vh]'}`}>
                <div className=' mx-5 sm:text-2xl mt-2 text-[15px]'>Liste des contrants expirés</div>
                                    ...
                                    {IsPrinting ? (
                                        ...
                                        <>
                                            <Whisper
                                                ...
                                                speaker={
                                                    <Popover>
                                                        Imprimer la liste des contrats
                                                    </Popover>
                                                }
                                            >
                                                <div onClick={() => { SetPrintAll(true); setTimeout(() => { handlePrint() }, 0); setTimeout(() => { SetPrintAll(false); }, 0); }} className='text-green-600  block p-2 hover:bg-green-200 bg-green-100 transition-all m-0.5 cursor-pointer rounded-lg'>
                                            ...
                                            <td className='p-1 border-r w-[5em]'>
                                                <div className='flex items-center justify-center w-full'>
                                                    <Whisper
                                                        ...
                                                        <Link to={`/contrant/expire/detail/${encryptData((datas.id).toString())}`} className='text-blue-600 block p-2 hover:bg-blue-200 m-0.5 cursor-pointer rounded-lg'>
    ...
    render() {
        ...
        return (
            <div class="w-full m-1 ">
                <div className='w-full'>
                    <div className=' mx-5 text-2xl  mb-4 font-bold  text-center'>Liste des contrants expirés</div>
