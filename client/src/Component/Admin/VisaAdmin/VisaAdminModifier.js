...
function VisaAdminModifier() {
    ...
    useEffect(() => {
        ...
        if (bourseDetails) {
            ...
            setSelectedCountryCode(bourseDetails.drapeaux)
            setcategorie(bourseDetails.categorie)
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://speedreal.abahs-jobconnect.com/visa/updatevisa/${bId}`, {
                            ...
                            <div className="justify-center overflow-hidden rounded-xl w-full h-max p-1 sm:p-2 mb-10  border-[1px] flex flex-col">
                                ...
                                <div class="w-full mb-5">
                                    ...
                                    >
                                        ...
                                        <option className="text-black cursor-pointer" value="VISA affaire">VISA d'affaire</option>
...
export default VisaAdminModifier;
