            ...
            <div className={`w-full overflow-y-auto overflow-x-hidden ${mobile1 ? 'h-[85vh]' : 'h-[80vh]'}`}>
                <div className={`w-full  overflow-hidden ${mobile1 ? 'min-h-[85vh]' : 'min-h-[80vh]'}`}>
                    ...
                    <div className='flex flex-wrap'>
                        <div>
                            <div className='text-[25px] text-gray-600 w-full  pl-5 mt-4'>Visa disponibles</div>
                            <div className={`grid  ${mobile3 ? 'grid-cols-2' : mobile ? 'grid-cols-3' : 'grid-cols-5 '}  m-2 rounded`}>
                                {visas.map((trav, index) => (
                                    ...
                                    >
                                        <Link to={`/visa/detail/${encryptData((trav.id).toString())}`} className='m-3 w-max' key={index}>
                                            <div className='flex items-center'>
                                                <img src={`https://flagcdn.com/w40/${trav.drapeaux.toLowerCase()}.png`} alt={`${trav.pays} flag`} />
                                                <div className='ml-2 text-[11px] sm:text-[20px]'>
