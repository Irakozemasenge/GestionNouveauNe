...
function EtudeAddAvantage() {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`https://speedreal.abahs-jobconnect.com/etude/addavantages/${bourseId}`, avantages)
            .then((resp) => {
                                            ...
                                            {avantages.map((avantage, avantageIndex) => (
                                                <div key={avantageIndex} className="flex items-center mt-1">
                                                    <input
                                                        ...
                                                        className={`block w-full bg-transparent outline-none focus:border focus:border-fuchsia-500 border border-red rounded py-3 px-4 ${validationErrors[avantageIndex].avantage ? 'border-red-500' : ''}`}
                                                    />
                                                    {avantageIndex <= 0 ? (
...
export default EtudeAddAvantage;
