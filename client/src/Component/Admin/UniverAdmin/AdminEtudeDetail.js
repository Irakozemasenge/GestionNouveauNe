...
function AdminEtudeDetail() {
    ...
    return (
        <div className='w-full'>
            ...
            <NavBarsEtude />
            <div div className={`w-full overflow-y-auto overflow-x-hidden ${mobile2 ? 'h-[85vh]' : 'h-[80vh]'}`}>
                <div className={`w-full  overflow-hidden ${mobile2 ? 'min-h-[85vh]' : 'min-h-[80vh]'}`}>
                    <div className='flex flex-wrap'>
                        <div className='w-full sm:p-3 m-0.5 rounded-xl h-max sm:m-2'>
                            ...
                            <div className="flex mt-4">
                                <Link to="/etude" className={`bg-blue-500 mr-0.5 hover:no-underline focus:no-underline hover:text-white focus:text-white hover:bg-blue-700 text-white font-bold py-2  rounded   mb-2  transition duration-300 ease-in-out ${mobile1 ? 'text-[10px] px-1' : 'px-4'} `}>Retourner</Link>
...
export default AdminEtudeDetail
