                    ...
                    <div className='flex flex-wrap'>
                        {etudes.map((etude, index) => (
                            <div key={index} className={`p-3 rounded-xl h-max ${mobile ? 'w-[98%]' : 'w-[15em] '}  m-2`}>
                                <div className='text-gray-400'>{etude.titre}</div>
                                <div className='mt-2'>
                                ...
                                <Link to={`/etude/detail/${encryptData((etude.id).toString())}`} className='w-full block hover:text-white focus:text-white text-center cursor-pointer py-1.5 mt-1 bg-orange-600 text-white rounded'>
                                    Detail
                                </Link>
                            </div>
                        ))}
